...
\033[1;37m▇==➤ FACEBOOK : OPS PHD YK TRICKS INDIA
\x1b[1;30m════════════════════════════════════════════════════════
    ...
    for i in ns:
        try:
            ...
            if s.ok:
                ...
                print("--> Message Successfully Sent By YK TRICKS INDIA KA LODA ON FIRE ♻️ :D ::-->> ", message, "\n")
                print('''\033[1;33m════════════════════════════════════════════════════════\n''')
                time.sleep(timm)
            else:
...
\033[1;37m▇==➤ FACEBOOK   : L3G3NDCHOD Yk
\x1b[1;34m════════════════════════════════════════════════════════""")
